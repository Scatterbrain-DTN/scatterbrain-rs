...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -312891531;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        43 => wire__crate__proto__ack_get_type_impl(port, ptr, rust_vec_len, data_len),
        44 => wire__crate__proto__ack_get_type_message_impl(port, ptr, rust_vec_len, data_len),
        45 => {
            wire__crate__api__types__crypto_config_generate_impl(port, ptr, rust_vec_len, data_len)
        }
        46 => wire__crate__proto__crypto_message_get_type_impl(port, ptr, rust_vec_len, data_len),
        47 => wire__crate__proto__crypto_message_get_type_message_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        48 => wire__crate__proto__get_events_get_type_impl(port, ptr, rust_vec_len, data_len),
        49 => {
            wire__crate__proto__get_events_get_type_message_impl(port, ptr, rust_vec_len, data_len)
        }
        50 => wire__crate__proto__get_identity_command_get_type_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        51 => wire__crate__proto__get_identity_command_get_type_message_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        52 => wire__crate__proto__get_messages_cmd_get_type_impl(port, ptr, rust_vec_len, data_len),
        53 => wire__crate__proto__get_messages_cmd_get_type_message_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        55 => wire__crate__proto__identity_response_get_type_message_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        56 => wire__crate__proto__import_identity_command_get_type_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        57 => wire__crate__proto__import_identity_command_get_type_message_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        58 => wire__crate__proto__import_identity_response_get_type_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        59 => wire__crate__proto__import_identity_response_get_type_message_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        60 => wire__crate__proto__message_response_get_type_impl(port, ptr, rust_vec_len, data_len),
        61 => wire__crate__proto__message_response_get_type_message_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        62 => wire__crate__proto__message_type_get_type_impl(port, ptr, rust_vec_len, data_len),
        63 => wire__crate__proto__message_type_get_type_message_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        64 => wire__crate__proto__pairing_ack_get_type_impl(port, ptr, rust_vec_len, data_len),
        65 => {
            wire__crate__proto__pairing_ack_get_type_message_impl(port, ptr, rust_vec_len, data_len)
        }
        66 => wire__crate__proto__pairing_initiate_get_type_impl(port, ptr, rust_vec_len, data_len),
        67 => wire__crate__proto__pairing_initiate_get_type_message_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        68 => wire__crate__proto__pairing_request_get_type_impl(port, ptr, rust_vec_len, data_len),
        69 => wire__crate__proto__pairing_request_get_type_message_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        70 => wire__crate__proto__pairing_syn_ack_get_type_impl(port, ptr, rust_vec_len, data_len),
        71 => wire__crate__proto__pairing_syn_ack_get_type_message_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        72 => wire__crate__proto__proto_uuid_as_proto_impl(port, ptr, rust_vec_len, data_len),
        73 => wire__crate__proto__proto_uuid_as_uuid_impl(port, ptr, rust_vec_len, data_len),
        74 => wire__crate__proto__sb_events_get_type_impl(port, ptr, rust_vec_len, data_len),
        75 => {
            wire__crate__proto__sb_events_get_type_message_impl(port, ptr, rust_vec_len, data_len)
        }
        76 => wire__crate__proto__send_message_cmd_get_type_impl(port, ptr, rust_vec_len, data_len),
        77 => wire__crate__proto__send_message_cmd_get_type_message_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        78 => wire__crate__proto__unit_response_get_type_impl(port, ptr, rust_vec_len, data_len),
        79 => wire__crate__proto__unit_response_get_type_message_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        80 => wire__crate__proto__unit_response_into_remote_err_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
